...
struct FolderView: View {
  ...
  @State private var forceRefreshTrigger: UUID = .init()
  ...
  // 拖拽相关状态
  @State private var draggingApp: AppInfo?
  ...
  @State private var outOfBoundsBeganAt: Date?
...
extension FolderView {
  ...
  private func cellOrigin(for index: Int,
    ...
    GeometryUtils.cellOrigin(for: index,
                             containerSize: containerSize,
                             pageIndex: 0,
                             columnWidth: columnWidth,
                             appHeight: appHeight,
